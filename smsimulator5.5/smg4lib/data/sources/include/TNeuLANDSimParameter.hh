#ifndef TNeuLANDSIMPARAMETER_HH
#define TNeuLANDSIMPARAMETER_HH
...
class TNeuLANDSimParameter : public TSimParameter
{
public:
  TNeuLANDSimParameter(TString name="NeuLANDParameter");
  virtual ~TNeuLANDSimParameter();
...
public:
  ...
  //       ID  parameter
  std::map<int,TDetectorSimParameter> fNeuLANDDetectorParameterMap;

  ClassDef(TNeuLANDSimParameter, 1)
};
